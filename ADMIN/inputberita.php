...
<?php
    ...
    if(isset($_POST['Simpan']))
    {
		...
		{
			move_uploaded_file($file_tmp, 'images/'.$beritaPIC); //unggah file ke folder images
            mysqli_query($connection, "insert into berita values ('$beritaKODE', '$beritaNAMA', '$beritaKET', '$beritaTGL', '$beritaPIC', '$beritaVID', '$kategoriKODE')");
        }
    }
        ...
        <div class="col-sm-10">
            <form method="POST" enctype="multipart/form-data">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="kodeberita" id="kodeberita" maxlength="4">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="ketberita" id="ketberita">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="beritaTGL" id="beritaTGL">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="beritaVID" id="beritaVID">
                    </div>
                </div>
            ...
            <table class="table table-dark table-hover">
                ...
                ?>
                    <tr>
                        ...
                        <td><iframe width="100px" height="55px" src="<?php echo $row['beritaVID']?>" frameborder="0" allowfullscreen></iframe></iframe></td>
