                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Input Restaurant</li>
                        </ol>
...
<?php 
    ...
    if (isset($_POST["Simpan"])) {
		...
		{
			move_uploaded_file($file_tmp, 'images/'.$restaurantPIC); //unggah file ke folder images
			mysqli_query($connection, "insert into restaurant values ('$restaurantKODE', '$restaurantNAMA', '$restaurantKET', '$restaurantPIC', '$destinasiKODE' )");
    ...
    <div class="row">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="koderestaurant" id="koderestaurant" maxlength="4">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="namarestaurant" id="namarestaurant">
                </div>
            </div>

            <div class="mb-3 row">
                <label for="ketrestaurant" class="col-sm-2 col-form-label">Keterangan Restaurant</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="ketrestaurant" id="ketrestaurant">
                </div>
            </div>
