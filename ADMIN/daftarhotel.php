    ...
    <div class="col-sm-1">
        ...
        <div class="col-sm-10">
            <div class="jumbotron mt-5">
                <h2 class="display-5">Daftar Hotel</h2>
            </div>
            ...
            <table class="table table-dark table-hover">
                <thead>
                    ...
                    <th scope="col">Nama Destinasi Hotel</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                    ...
                    if(isset($_POST["kirim"])) {
                        $search = $_POST["search"];
                        $query = mysqli_query($connection,"select * from hotel, destinasi where hotel.destinasiKODE = destinasi.destinasiKODE AND hotelNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
                    }else
                    {
