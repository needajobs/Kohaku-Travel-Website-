    ...
    <div class="col-sm-1">
        ...
        <div class="col-sm-10">
            ...
            <?php 
                ...
                {
                    $search = $_POST["search"];
                    $query = mysqli_query($connection, "select * from destinasi, kategoriwisata where destinasi.kategoriKODE = kategoriwisata.kategoriKODE AND destinasiNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
                }else
                    {
