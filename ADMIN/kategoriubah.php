...
<?php
	...
	if(isset($_POST['edit']))
	{
		...
		$kategoriREFERENCE = $_POST["inputRefKategori"];
		
		mysqli_query($connection, "update kategoriwisata set kategoriKODE = '$kategoriKODE', kategoriNAMA = '$kategoriNAMA', kategoriKET = '$kategoriKET', kategoriREFERENCE = '$kategoriREFERENCE' where kategoriKODE = '$kategoriKODE'");
        echo "<script>alert('DATA BERHASIL DIUBAH'); document.location='inputkategori.php'</script>";
		...
		<div class="col-sm-10">
			<form method="POST">
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="kategoriKODE" name="inputKategoriKode" value="<?php echo $rowedit["kategoriKODE"] ?>" readonly>
					</div>
				</div>
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="kategoriNAMA" name="inputKategoriNama" value="<?php echo $rowedit["kategoriNAMA"] ?>">
					</div>
				</div>
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="kategoriKET" name="inputKetKategori" value="<?php echo $rowedit["kategoriKET"] ?>">
					</div>
				</div>
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="kategoriREF" name="inputRefKategori" value="<?php echo $rowedit["kategoriREFERENCE"] ?>">
					</div>
				</div>
