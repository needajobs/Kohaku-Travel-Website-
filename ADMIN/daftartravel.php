    ...
    <div class="col-sm-1">
        ...
        <div class="col-sm-10">
            <div class="jumbotron mt-5">
                <h2 class="display-5">Daftar Travel</h2>
            </div>
            ...
            <table class="table table-dark table-hover">
                ...
                <?php
                    ...
                    if(isset($_POST["kirim"])) {
                        $search = $_POST["search"];
                        $query = mysqli_query($connection,"select * from travel, destinasi where travel.destinasiKODE = destinasi.destinasiKODE AND travelNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
                    }else
                    {
