    ...
    <div class="col-sm-1">
        ...
        <div class="col-sm-10">
            <div class="jumbotron mt-5">
                <h2 class="display-5">Daftar Oleh - Oleh</h2>
            </div>
            ...
            <table class="table table-dark table-hover">
                <thead>
                    ...
                    <th scope="col">Nama Daerah Oleh - Oleh</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                    ...
                    if(isset($_POST["kirim"])) {
                        $search = $_POST["search"];
                        $query = mysqli_query($connection,"select * from oleholeh, destinasi where oleholeh.destinasiKODE = destinasi.destinasiKODE AND olehNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
                    }else
                    {
                        $query = mysqli_query($connection,"select * from oleholeh, destinasi where oleholeh.destinasiKODE = destinasi.destinasiKODE limit $mulaitampilan, $jumlahtampilan");
                    }
