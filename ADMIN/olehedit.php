                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Edit Oleh - Oleh</li>
                        </ol>
<?php
    ...
    if(isset($_POST['edit']))
    {
		...
		if (isset($_FILES['file'])) {
            ...
            if (($ekstensifile == "jpg") or ($ekstensifile == "JPG")) {
                move_uploaded_file($file_tmp, 'images/' . $olehPIC);
    
                mysqli_query($connection, "update oleholeh set olehNAMA='$olehNAMA', olehKET ='$olehKET', olehPIC ='$olehPIC', destinasiKODE = '$destinasiKODE' WHERE olehKODE='$olehKODE'");
                echo "<script>alert('DATA BERHASIL DIUBAH'); document.location='inputoleholeh.php'</script>";
            }
        }
        mysqli_query($connection, "update oleholeh set olehNAMA='$olehNAMA', olehKET ='$olehKET', destinasiKODE = '$destinasiKODE' WHERE olehKODE='$olehKODE'");
        echo "<script>alert('DATA BERHASIL DIUBAH'); document.location='inputoleholeh.php'</script>";
    }
        ...
        <div class="col-sm-10">
            <form method="POST" enctype="multipart/form-data">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="kodeoleh" id="kodeoleh" value="<?php echo $rowedit["olehKODE"] ?>" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="namaoleh" class="col-sm-3 col-form-label">Nama Oleh - Oleh</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="namaoleh" id="namaoleh" value="<?php echo $rowedit["olehNAMA"] ?>">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="olehket" class="col-sm-3 col-form-label">Keterangan Oleh - Oleh</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="olehket" id="olehket" value="<?php echo $rowedit["olehKet"] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
			        ...
			        <div class="col-sm-9">
                        ...
                        <img src="images/<?php echo $rowedit['olehPIC']; ?>" width="80">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="kodedestinasi" name="destinasikode">
