       ...
       // PERIKSA EKSTEN FILE HARUS JPG ATAU jpg
		if (isset($_FILES['file'])) {
            ...
            if (($ekstensifile == "jpg") or ($ekstensifile == "JPG")) { 
                move_uploaded_file($file_tmp, 'images/' . $hotelPIC);
    
                mysqli_query($connection, "update hotel set hotelNAMA='$namahotel', hotelALAMAT='$alamathotel', hotelPIC = '$hotelPIC', hotelKET = '$hotelKET', hotelHARGA = '$hotelHARGA', destinasiKODE='$destinasikode' where hotelKODE='$kodehotel'");
                echo "<script>alert('DATA BERHASIL DIUBAH'); document.location='inputhotel.php'</script>";
            }
        }
        mysqli_query($connection, "update hotel set hotelNAMA='$namahotel', hotelALAMAT='$alamathotel', hotelKET = '$hotelKET', hotelHARGA = '$hotelHARGA', destinasiKODE='$destinasikode' where hotelKODE='$kodehotel'");
        echo "<script>alert('DATA BERHASIL DIUBAH'); document.location='inputhotel.php'</script>";
    }
            ...
            <div class="col-sm-10">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="kodeHotel" id="kodehotel" value="<?php echo $rowedit["hotelKODE"] ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="namaHotel" id="namadestinasi" value="<?php echo $rowedit["hotelNAMA"] ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="alamatHotel" id="alamathotel" value="<?php echo $rowedit["hotelALAMAT"] ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="hotelKET" id="hotelKET" value="<?php echo $rowedit["hotelKET"] ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="hotelHARGA" id="hotelHARGA" value="<?php echo $rowedit["hotelHARGA"] ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <img src="images/<?php echo $rowedit['hotelPIC']; ?>" width="80">
                ...
                <div class="jumbotron mt-5">
                    <h2 class="display-5">Hasil entri datahotel</h2>
                </div>
