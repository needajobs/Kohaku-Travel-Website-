                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Input Travel</li>
                        </ol>
...
<?php 
    ...
    if (isset($_POST["Simpan"])) {
		...
		{
			move_uploaded_file($file_tmp, 'images/'.$travelPIC); //unggah file ke folder images
			mysqli_query($connection, "insert into travel values ('$travelKODE', '$travelNAMA', '$travelKET', '$travelPIC', '$destinasiKODE')");
        }
    }
